 ...
 *Name: Kristen Qako
 *Date: 4/30/2019
 *Specification File: Sortable_list.cc 
 *Implements all of the ordering algorithms that are in the sortable_list.h file
 *
 **************************/
...
/*
  Post: The entries of the Sortable_list have been rearranged into an increasing order.
*/
{
    for(int size = 0; size < List<Record>::count;size++){
        for(int position = 0; position < List<Record>::count - size - 1; position++){
